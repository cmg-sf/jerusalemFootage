      ...
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>Jerusalem</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>Jerusalem <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">JerusalemFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
          <div className="hr-red"/>
          <section className="category-sec">
            <h1>Browse by Category</h1>
            <div className="categories">
						<a href="https://stockfootage.com/?s=israel+Bethlehem&post_type=product" className="cat">Bethlehem</a>
						<a href="https://stockfootage.com/?s=israel+Holy+Sepulchre&post_type=product" className="cat">Holy Sepulchre</a>
						...
						<a href="https://stockfootage.com/?s=israel+Garden+Tomb&post_type=product" className="cat">Garden Tomb</a>
            </div>
          </section>
          <br/>
          <div className="hr-red"/>
          <section className="contributors">
            ...
            <div className="contributor-previews">
              ...
              <div className="contributor-preview">
                <iframe title="yt3" width="350" height="195" src="https://www.youtube.com/embed/HEvsZtw-vJE" frameBorder="0" allowFullScreen></iframe>
              </div>
            </div>
